...
public class HistóricoSimulação extends javax.swing.JFrame {
     ...
     * @throws IOException 
     */
    public HistóricoSimulação() throws SQLException, IOException {
        super("Solartoyour");
        initComponents();
    ...
    private void initComponents() throws SQLException, IOException {
        ...
        double[] valores = Historico.getHistorico(TXT.ler());
        
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {valores[0], valores[1], Historico.getData(TXT.ler()), valores[2], valores[3], valores[4],valores[5]},
